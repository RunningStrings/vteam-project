...
const seedData = async () => {
    ...
    try {
      ...
      const chargingStationsData = [
        { city_id: 'Stockholm', location: { type: 'Point', coordinates: [18.053755700927717,59.33790633117423] }, bikes: [], capacity: 10 },
        { city_id: 'Linköping', location: { type: 'Point', coordinates: [15.608389030566414,58.4141407833687] }, bikes: [], capacity: 25 },
        { city_id: 'Linköping', location: { type: 'Point', coordinates: [15.617143760791024,58.41306744186601,] }, bikes: [], capacity: 12 },
      ...
      const parkingZonesData = [
        { city_id: 'Stockholm', location: { type: 'Polygon', coordinates: [ [18.066412977603,59.34084608742432], [18.06584648145719,59.34088914775366], [18.06627927206204,59.34069537073425], [18.066412977603,59.34084608742432]] } },
        { city_id: 'Stockholm', location: { type: 'Polygon', coordinates: [ [18.07004381658114,59.33009383540676], [18.07034409689281,59.33016726740666], [18.07000680186237,59.33021133439787], [18.07004381658114,59.33009383540676] ] } },
        { city_id: 'Linköping', location: { type: 'Polygon', coordinates: [ [15.61766041309972,58.41061539690683], [15.61766040934009,58.41050051213356], [15.61814290956508,58.41055029045644], [15.61809905144455,58.41066900531456], [15.61766041309972,58.41061539690683] ] } },
